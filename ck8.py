    ...
    if "region" in data:
        for region in data["region"]:
            try:
                ...
                # Only use the English class name
                ET.SubElement(obj, "name").text = obj_class if obj_class != "unknown" else name
...
if __name__ == "__main__":
    json_directory = "/home/depth/桌面/sj/jpg/"  # Replace with your JSON files path
    xml_directory = "/home/depth/桌面/sj/jpg/"  # Replace with your desired XML output path

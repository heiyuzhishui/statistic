...
def create_xml(json_data, json_file_path):
    ...
    # 从JSON中获取图像文件名
    image_name = data.get('file', {}).get('name') or data.get('imageName')
    if not image_name:
        print(f"Warning: No image name found in JSON")
        return None
        ...
        if json_file.endswith('.json'):
            ...
            try:
                ...
                if annotation:
                    ...
                    raise Exception("Failed to create XML string")
...
if __name__ == "__main__":
    json_directory = "/home/depth/20241205/npg/20240914数据4165"  # Replace with your JSON files path
    xml_directory = "/home/depth/20241205/xml/20240914数据4165"  # Replace with your desired XML output path

...
# 标签映射字典
LABEL_MAPPING = {
    'shoes': ['shoes', 'socks', 'Slippers / shoes', 'Slippers', 'Socks', 'socks'],  # 添加Slippers和更多socks变体

    'bin': ['trash_can', 'trash can', 'trash'],  # 添加trash

    'pedestal': ['base', 'Fan base', 'Metal chair base', 'base'],  # 添加base

    'wire': ['cable', 'Cable', 'charger', 'Electric', 'wire', 'cable', 'Cable', 'charger'],  # 添加wire和更多cable变体

    'socket': ['plug_in_board', 'plug_in_board'],  # 添加完全匹配的变体

    'cat': ['pet_cat', 'pet_unknown', 'Cat bowl / dog bowl', 'pet_hairbolls', 'Cat', 'pet_cat'],  # 添加Cat变体

    'dog': ['pet_unknown', 'pet_dog', 'Cat bowl / dog bowl', 'pet_dog'],  # 添加完全匹配的变体

    'desk_rect': ['table', 'Table', 'dining_table', 'bedside_table', 'tea', 'table', 'Table', 'dining_table', 'bedside_table'],  # 添加更多table变体

    'desk_circle': ['table', 'Table', 'dining_table', 'bedside_table',  'tea', 'table', 'Table', 'dining_table', 'bedside_table'],  # 添加相同的table变体

    'weighing-scale': ['weight_scale', 'Weighing scale', 'Weighing', 'weight_scale'],  # 添加Weighing变体

    'key': ['keys', 'keys'],  # 添加完全匹配的变体

    'person': ['person', 'person'],  # 添加完全匹配的变体

    'chair': ['chair', 'chair'],  # 添加完全匹配的变体

    'couch': ['sofa', 'Sofa', 'couch', 'sofa', 'Sofa'],  # 添加更多sofa变体

    'bed': ['bed', 'Bed', 'bed', 'Bed'],  # 添加完全匹配的变体

    'tvCabinet': ['tv_cabinet', 'TV cabinet', 'tv_cabinet', 'TV'],  # 添加TV变体

    'fridge': ['refrigerator', 'fridge', 'Refrigerator'],  # 添加Refrigerator变体

    'television': ['screen', 'television', 'Television', 'TV', 'screen'],  # 添加Television和TV变体

    'washingMachine': ['washing_machine', 'Washing machine', 'Washing'],  # 添加Washing变体

    'electricFan': ['Fan', 'Fan'],  # 添加完全匹配的变体

    'remoteControl': [],  # 保持空列表

    'shoeCabinet': ['shoebox', 'shoeCabinet', 'shoebox']  # 添加完全匹配的变体
}
...
if __name__ == "__main__":
    json_directory = "/home/depth/20241205/img/20240919数据6478"  # Replace with your JSON files path
    xml_directory = "/home/depth/20241205/xml/20240919数据6478"  # Replace with your desired XML output path
    process_directory(json_directory, xml_directory)

# 0924数据9520.zip  20240914数据4165  20240918数据6086  9.13数据9520
# 20240913          20240914数据6129  20240919数据6478
